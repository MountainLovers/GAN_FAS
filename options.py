...
parser.add_argument('--train_file_list', type=str, default='/public/zzj/Oulu-NPU/Protocols/Protocol_1/depth/Train.txt', help='train_file_list')
parser.add_argument('--dev_file_list', type=str, default='/public/zzj/Oulu-NPU/Protocols/Protocol_1/depth/Dev.txt', help='dev_file_list')
parser.add_argument('--test_file_list', type=str, default='/public/zzj/Oulu-NPU/Protocols/Protocol_1/depth/Test.txt', help='test_file_list')
...
parser.add_argument('--w_L1', type=int, default=1, help='weight of L1 loss')
