...
parser.add_argument('--train_file_list', type=str, default='/mnt/hdd.user/datasets/FAS/Oulu-NPU/Protocols/Protocol_2/Train_list.txt', help='train_file_list')
parser.add_argument('--dev_file_list', type=str, default='/mnt/hdd.user/datasets/FAS/Oulu-NPU/Protocols/Protocol_2/Dev_list.txt', help='dev_file_list')
parser.add_argument('--test_file_list', type=str, default='/mnt/hdd.user/datasets/FAS/Oulu-NPU/Protocols/Protocol_2/Test_list.txt', help='test_file_list')
