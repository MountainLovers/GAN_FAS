...
parser.add_argument('--train_file_list', type=str, default='/mnt/hdd.user/datasets/FAS/Oulu-NPU/Protocols/Protocol_1/Train_proto.txt', help='train_file_list')
parser.add_argument('--dev_file_list', type=str, default='/mnt/hdd.user/datasets/FAS/Oulu-NPU/Protocols/Protocol_1/Dev_proto.txt', help='dev_file_list')
parser.add_argument('--test_file_list', type=str, default='/mnt/hdd.user/datasets/FAS/Oulu-NPU/Protocols/Protocol_1/Test_proto.txt', help='test_file_list')
...
parser.add_argument('--w_NP', type=float, default=0.7, help='weight of NP loss')
