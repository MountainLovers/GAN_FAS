...
def mask_3dmad_main():
    TRAIN_FILE_DIR = "/mnt/hdd.user/datasets/3DMAD/Data"

    TRAIN_FRAME_DIR = "/mnt/hdd.user/datasets/3DMAD/frames"
...
def mask_surf_main():
    ...
    TRAIN_FRAME_DIR = "/mnt/hdd.user/datasets/CASIA-SURF-3DMask/CASIA_SURF_3DMask/frames"
    ...
    videos = get_all_files(src_dir, ".MOV")
    for video_path in videos:
        basename = os.path.basename(video_path)
        filename, extname = os.path.splitext(basename)
